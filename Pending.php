...
<div class="row">
	...
	<div class="column2"> 
		<table> 
			...
			$queryT = "SELECT * FROM tasktable, statustable, duetable WHERE tasktable.taskId = statustable.taskId AND tasktable.taskId = duetable.taskId AND statustable.status = 'pending' GROUP BY tasktable.taskId";
